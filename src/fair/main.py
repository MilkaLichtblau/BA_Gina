...
def createAndRankTREC(k):
    ...
    protectedGermanCreditGender, nonProtectedGermanCreditGender = germanCreditData.create(
        "../data/features_with_total_order-withGender_withZscore_1-60.csv", "query_id", "match_body_email_subject_score_norm",
        "match_body_email_subject_df_stdev", "match_body_email_subject_idf_stdev", "match_body_score_norm",
        "match_subject_score_norm", "judgement", protectedAttribute=["female"])
    rankAndDump(protectedGermanCreditGender, nonProtectedGermanCreditGender, k,
                       "GermanCreditGender", "../results/rankingDumps/German Credit/Gender",
                       pairsOfPAndAlpha)
